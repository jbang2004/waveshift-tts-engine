...
class DataFetcher:
    ...
    async def fetch_task_data_parallel(self, task_id: str, path_manager: PathManager = None) -> Dict:
        """
        ...
        try:
            ...
            if media_paths.get('audio_path'):
                audio_task = asyncio.create_task(
                    self._download_and_separate_audio_parallel(task_id, media_paths['audio_path'], path_manager),
            ...
            if media_paths.get('video_path'):
                video_task = asyncio.create_task(
                    self._download_video_file_async(task_id, media_paths['video_path'], path_manager),
    ...
    async def _download_and_separate_audio_parallel(self, task_id: str, audio_path_r2: str, 
    ...
    async def _download_video_file_async(self, task_id: str, video_path_r2: str, 
